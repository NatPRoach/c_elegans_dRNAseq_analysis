...
# novel_in = open("../../../results/utrs/beds/novel/all_novel_utrs.bed")
...
#
# l1_out = open("../../../results/utrs/beds/novel/L1_novel_utrs.bed",'w')
# l2_out = open("../../../results/utrs/beds/novel/L2_novel_utrs.bed",'w')
# l3_out = open("../../../results/utrs/beds/novel/L3_novel_utrs.bed",'w')
# l4_out = open("../../../results/utrs/beds/novel/L4_novel_utrs.bed",'w')
# ya_out = open("../../../results/utrs/beds/novel/YA_novel_utrs.bed",'w')
# ga_out = open("../../../results/utrs/beds/novel/GA_novel_utrs.bed",'w')
# ml_out = open("../../../results/utrs/beds/novel/ML_novel_utrs.bed",'w')
#
# outfile = open("../../../results/scratch/novelUTRs/novelUTRs.txt",'w')
#
# novel_set = sets.Set()
# l1_set = sets.Set()
# l2_set = sets.Set()
...
novel_in = open("../../../results/utrs/beds/novel/all_sensitive_novel_utrs.bed")
...
l1_out = open("../../../results/utrs/beds/novel/L1_sensitive_novel_utrs.bed",'w')
l2_out = open("../../../results/utrs/beds/novel/L2_sensitive_novel_utrs.bed",'w')
l3_out = open("../../../results/utrs/beds/novel/L3_sensitive_novel_utrs.bed",'w')
l4_out = open("../../../results/utrs/beds/novel/L4_sensitive_novel_utrs.bed",'w')
ya_out = open("../../../results/utrs/beds/novel/YA_sensitive_novel_utrs.bed",'w')
ga_out = open("../../../results/utrs/beds/novel/GA_sensitive_novel_utrs.bed",'w')
ml_out = open("../../../results/utrs/beds/novel/ML_sensitive_novel_utrs.bed",'w')

outfile = open("../../../results/scratch/novelUTRs/sensitive_novelUTRs.txt",'w')
...
novel_in = open("../../../results/utrs/beds/novel/all_stringent_novel_utrs.bed")
...
l1_out = open("../../../results/utrs/beds/novel/L1_stringent_novel_utrs.bed",'w')
l2_out = open("../../../results/utrs/beds/novel/L2_stringent_novel_utrs.bed",'w')
l3_out = open("../../../results/utrs/beds/novel/L3_stringent_novel_utrs.bed",'w')
l4_out = open("../../../results/utrs/beds/novel/L4_stringent_novel_utrs.bed",'w')
ya_out = open("../../../results/utrs/beds/novel/YA_stringent_novel_utrs.bed",'w')
ga_out = open("../../../results/utrs/beds/novel/GA_stringent_novel_utrs.bed",'w')
ml_out = open("../../../results/utrs/beds/novel/ML_stringent_novel_utrs.bed",'w')

outfile = open("../../../results/scratch/novelUTRs/stringent_novelUTRs.txt",'w')
