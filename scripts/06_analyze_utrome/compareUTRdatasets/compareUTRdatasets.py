...
bartel_utrs   = open("../../../references/utrs/jan_utrs.bed",'r')
wormbase_utrs = open("../../../references/utrs/wormbase_utrs.bed",'r')
outfile = open("../../../results/overlaps/sensitive_utr.overlap.matrix",'w')
outfile2 = open("../../../results/utrs/beds/novel/all_sensitive_novel_utrs.bed",'w')
window = 10
...
bartel_utrs   = open("../../../references/utrs/jan_utrs.bed",'r')
wormbase_utrs = open("../../../references/utrs/wormbase_utrs.bed",'r')
outfile = open("../../../results/overlaps/stringent_utr.overlap.matrix",'w')
outfile2 = open("../../../results/utrs/beds/novel/all_stringent_novel_utrs.bed",'w')
window = 10
