...
l1_in = open("../../results/new_isoforms/L1_new_isoforms.tsv")
l2_in = open("../../results/new_isoforms/L2_new_isoforms.tsv")
l3_in = open("../../results/new_isoforms/L3_new_isoforms.tsv")
l4_in = open("../../results/new_isoforms/L4_new_isoforms.tsv")
ya_in = open("../../results/new_isoforms/YA_new_isoforms.tsv")
ga_in = open("../../results/new_isoforms/GA_new_isoforms.tsv")
ml_in = open("../../results/new_isoforms/ML_new_isoforms.tsv")
