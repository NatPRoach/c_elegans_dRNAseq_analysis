...
l1_in = open("../../results/new_isoforms/L1_stringent_new_isoforms.tsv")
l2_in = open("../../results/new_isoforms/L2_stringent_new_isoforms.tsv")
l3_in = open("../../results/new_isoforms/L3_stringent_new_isoforms.tsv")
l4_in = open("../../results/new_isoforms/L4_stringent_new_isoforms.tsv")
ya_in = open("../../results/new_isoforms/YA_stringent_new_isoforms.tsv")
ga_in = open("../../results/new_isoforms/GA_stringent_new_isoforms.tsv")
ml_in = open("../../results/new_isoforms/ML_stringent_new_isoforms.tsv")
