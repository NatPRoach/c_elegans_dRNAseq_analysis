...
outfile1 = open("../../results/scratch/countGenesAndIsoforms/sensitive_staged_gene_and_isoform_count.txt",'w')
outfile2 = open("../../results/scratch/countGenesAndIsoforms/sensitive_staged_novel_gene_and_isoform_count.txt",'w')
...
outfile1 = open("../../results/scratch/countGenesAndIsoforms/stringent_staged_gene_and_isoform_count.txt",'w')
outfile2 = open("../../results/scratch/countGenesAndIsoforms/stringent_staged_novel_gene_and_isoform_count.txt",'w')
