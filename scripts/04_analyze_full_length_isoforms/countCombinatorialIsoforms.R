...
df <- read.table("results/scratch/countCombinatorialIsoforms/sensitive_combinatorial_isoform_count.txt",sep = "\t", header= TRUE)
...
pdf(file="figures/figure1/sensitive_figure1F.pdf",height=2.0834,width=4.35,colormodel="rgb")
print(g2)
dev.off()


df2 <- read.table("results/scratch/countCombinatorialIsoforms/sensitive_combinatorial_isoform_count_subsampled.txt",sep="\t",header=TRUE)
df2$stage <- factor(df2$stage,levels = c("L1","L2","L3","L4","young adult","mature adult","male","all"))
...
pdf(file="figures/figure1/sensitive_figure1G.pdf",height=2.5,width=5,colormodel="rgb")
print(g4)
dev.off()
...
pdf(file="figures/supplementals/sfigure2/sensitive_sfigure2A.pdf",height=2.5,width=5,colormodel="rgb")
print(g4)
dev.off()
...
df <- read.table("results/scratch/countCombinatorialIsoforms/stringent_combinatorial_isoform_count.txt",sep = "\t", header= TRUE)
...
pdf(file="figures/figure1/stringent_figure1F.pdf",height=2.0834,width=4.35,colormodel="rgb")
print(g2)
dev.off()


df2 <- read.table("results/scratch/countCombinatorialIsoforms/stringent_combinatorial_isoform_count_subsampled.txt",sep="\t",header=TRUE)
df2$stage <- factor(df2$stage,levels = c("L1","L2","L3","L4","young adult","mature adult","male","all"))
...
pdf(file="figures/figure1/stringent_figure1G.pdf",height=2.5,width=5,colormodel="rgb")
print(g4)
dev.off()
...
pdf(file="figures/supplementals/sfigure2/stringent_sfigure2A.pdf",height=2.5,width=5,colormodel="rgb")
print(g4)
dev.off()
