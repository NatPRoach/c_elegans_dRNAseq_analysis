...
def printCombinatorialIsoforms(infile,utr_assignments,utr_end_points,outfile):
    ...
    for line in infile:
        ...
        if len(uniq_utrs) == 0:
            ...
            isoform_label = gene + "-IntronRetainedSpliceform" + str(gene_spliceform_counter[gene]) + "-NoUTR"
            if strand == '+':
            ...
            for cluster_id in uniq_utrs:
                ...
                isoform_label = gene + "-IntronRetainedSpliceform" + str(gene_spliceform_counter[gene]) + "-UTR" + utr_id
...
### Stringent
total_utrs = open("../../results/utrs/assignments/all_stringent_intron_isoforms_utrs.tsv")
total_bed = open("../../results/utrs/beds/all_stringent_intron_isoforms_utrs.bed")
utr_assignments = {}
utr_end_points = {}
for line in total_utrs:
    fields = line.strip().split()
...
total_in = open("../../results/isoforms/all_stringent_intron_isoforms.tsv")
outfile = open("../../results/isoforms/stringent_combinatorial_isoforms_intron.bed",'w')
printCombinatorialIsoforms(total_in,utr_assignments,utr_end_points,outfile)
