...
txoutfile2 =   open("../../results/scratch/polya/fulls/all_stringent.full.polya"  ,'w')
...
tmp_tx_id_file = open("../../results/correctionLogs/l1_stringent.gene.txt")
for line in tmp_tx_id_file:
    fields = line.strip().split()
    if len(fields) != 4:
        continue
...
tmp_tx_id_file = open("../../results/correctionLogs/l2_stringent.gene.txt")
for line in tmp_tx_id_file:
    fields = line.strip().split()
    if len(fields) != 4:
        continue
...
tmp_tx_id_file = open("../../results/correctionLogs/l3_stringent.gene.txt")
for line in tmp_tx_id_file:
    fields = line.strip().split()
    if len(fields) != 4:
        continue
...
tmp_tx_id_file = open("../../results/correctionLogs/l4_stringent.gene.txt")
for line in tmp_tx_id_file:
    fields = line.strip().split()
    if len(fields) != 4:
        continue
...
tmp_tx_id_file = open("../../results/correctionLogs/ya_stringent.gene.txt")
for line in tmp_tx_id_file:
    fields = line.strip().split()
    if len(fields) != 4:
        continue
...
tmp_tx_id_file = open("../../results/correctionLogs/ga_stringent.gene.txt")
for line in tmp_tx_id_file:
    fields = line.strip().split()
    if len(fields) != 4:
        continue
...
tmp_tx_id_file = open("../../results/correctionLogs/ml_stringent.gene.txt")
for line in tmp_tx_id_file:
    fields = line.strip().split()
    if len(fields) != 4:
        continue
...
# ### Sensitive
#
# txoutfile2 =   open("../../results/scratch/polya/fulls/all_sensitive.full.polya"  ,'w')
#
# ## Initialize dictionaries used to store data
# tx_id_to_lengths = {} #for each tx_id (# of reads, [polyA lengths])
# gene_id_to_lengths = {} # for each gene_id (# of reads, [polyA lengths])
...
#
#
# tmp_tx_id_file = open("../../results/correctionLogs/l1_sensitive.gene.txt")
# for line in tmp_tx_id_file:
#     fields = line.strip().split()
#     if len(fields) != 4:
#         continue
...
#
#
# tmp_tx_id_file = open("../../results/correctionLogs/l2_sensitive.gene.txt")
# for line in tmp_tx_id_file:
#     fields = line.strip().split()
#     if len(fields) != 4:
#         continue
...
#             gene_id_to_lengths[gene_id] = [1, [read_id_to_length[read_id]]]
#
# tmp_tx_id_file = open("../../results/correctionLogs/l3_sensitive.gene.txt")
# for line in tmp_tx_id_file:
#     fields = line.strip().split()
#     if len(fields) != 4:
#         continue
...
#             gene_id_to_lengths[gene_id] = [1, [read_id_to_length[read_id]]]
#
# tmp_tx_id_file = open("../../results/correctionLogs/l4_sensitive.gene.txt")
# for line in tmp_tx_id_file:
#     fields = line.strip().split()
#     if len(fields) != 4:
#         continue
...
#             gene_id_to_lengths[gene_id] = [1, [read_id_to_length[read_id]]]
#
# tmp_tx_id_file = open("../../results/correctionLogs/ya_sensitive.gene.txt")
# for line in tmp_tx_id_file:
#     fields = line.strip().split()
#     if len(fields) != 4:
#         continue
...
#             gene_id_to_lengths[gene_id] = [1, [read_id_to_length[read_id]]]
#
# tmp_tx_id_file = open("../../results/correctionLogs/ga_sensitive.gene.txt")
# for line in tmp_tx_id_file:
#     fields = line.strip().split()
#     if len(fields) != 4:
#         continue
...
#
#
# tmp_tx_id_file = open("../../results/correctionLogs/ml_sensitive.gene.txt")
# for line in tmp_tx_id_file:
#     fields = line.strip().split()
#     if len(fields) != 4:
#         continue
